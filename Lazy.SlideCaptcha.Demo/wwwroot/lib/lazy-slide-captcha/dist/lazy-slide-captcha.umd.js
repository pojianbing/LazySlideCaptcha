(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["lazy-slide-captcha"] = factory();
	else
		root["lazy-slide-captcha"] = factory();
...
;// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js??clonedRuleSet-80[0].rules[0].use[1]!./node_modules/@vue/cli-service/node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./src/package/lazy-slide-captcha/index.vue?vue&type=script&lang=js&
...
//
//
/* harmony default export */ var lazy_slide_captchavue_type_script_lang_js_ = ({
  ...
  mounted: function mounted() {
    var dragEl = this.$refs.dragVerify;
  ...
  computed: {
    ...
    dragVerifyStyle: function dragVerifyStyle() {
      return {
        width: this.width + "px",
    ...
    progressBarStyle: function progressBarStyle() {
      return {
        ...
        height: this.barHeight + "px",
        borderRadius: this.circle ? this.barHeight / 2 + "px 0 0 " + this.barHeight / 2 + "px" : this.radius
      };
    },
    ...
    handlerSvgStyle: function handlerSvgStyle() {
      return {
  ...
  methods: {
    // 开始请求生成图片时调用
    startRequestGenerate: function startRequestGenerate() {
      this.reset();
      this.showGenerateLoadding = true;
    },
    // 结束请求生成图片时调用
    endRequestGenerate: function endRequestGenerate(src, sliderSrc) {
      this.showGenerateLoadding = false;
      this.src = src;
      this.sliderSrc = sliderSrc;
    },
    // 开始请求校验时调用
    startRequestVerify: function startRequestVerify() {
      this.showVerifyLoadding = true;
    },
    // 结束请求校验时调用
    endRequestVerify: function endRequestVerify(isPassing) {
    ...
    handleDragMoving: function handleDragMoving(e) {
    ...
    handleDragFinish: function handleDragFinish() {
      if (this.isMoving && !this.isPassing && this.src && this.sliderSrc && !this.isFinish) {
        this.isMoving = false;
        this.isFinish = true;
        this.removeEventListeners();
...
;// CONCATENATED MODULE: ./src/package/lazy-slide-captcha/index.vue
...
var component = normalizeComponent(
  package_lazy_slide_captchavue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var lazy_slide_captcha = (component.exports);
;// CONCATENATED MODULE: ./src/package/lazy-slide-captcha/index.js


/* istanbul ignore next */

lazy_slide_captcha.install = function (Vue) {
  Vue.component(lazy_slide_captcha.name, lazy_slide_captcha);
};

/* harmony default export */ var package_lazy_slide_captcha = (lazy_slide_captcha);
;// CONCATENATED MODULE: ./src/package/index.js




var components = [package_lazy_slide_captcha];
...
//# sourceMappingURL=lazy-slide-captcha.umd.js.map